...
label_dir = '/tensorflow1/models/research/deeplab/datasets/PQR/dataset/SegmentationClass/'
new_label_dir = '/tensorflow1/models/research/deeplab/datasets/PQR/dataset/SegmentationClassRaw/'
