...
_PQR_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 3000, # number of file in the train folder
        'trainval': 3552,
        'val': 552,
    },
...
# _PQR_SEG_INFORMATION = DatasetDescriptor(
     # splits_to_sizes={
         # 'train': 1000, # number of file in the train folder
         # 'trainval': 1186,
         # 'val': 185,
     # },
     # num_classes=2, # number of classes in your dataset
...
_rgb_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 1800, # number of file in the train folder
        'trainval': 40,
        'val': 20,
    },
    num_classes=2, # number of classes in your dataset
...
_kaggle_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 2805, # number of file in the train folder
        'trainval': 3552,
        'val': 195,
    },
...
_covid_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 5000, # number of file in the train folder
        'trainval': 5403,
        'val': 403,
    },
...
_DATASETS_INFORMATION = {
	...
	'rgb': _rgb_INFORMATION,
	'kaggle': _kaggle_INFORMATION,
	'covid': _covid_INFORMATION
